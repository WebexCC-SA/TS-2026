...
2. In the **Welcome message** text replace the word ***there*** with ***{{customer_name}}***<span class="copy-static" data-copy-text="{{customer_name}}"><span class="copy" title="Click to copy!"></span></span>. In this case we expect that the caller will hear: **Hi** ***dear customer***, **my name is Blossom, the AI Agent. How can I assist you?***
